...
let colors = ['yellow','green', 'blue', 'red','orange']; //untuk pieplot
...
let dataSheet;
let urlAPI = 'https://api.openweathermap.org/data/2.5/weather?q=Lampung&appid=6796bf8849dc829ab17d197b5c34bdbc&units=metric'
let dataAPI;
...
function infoCuaca(x, y, data, fontsize){ 
  ...
  text("Temperature = "+ data.main.temp,   
      posX = x ,   
      posY = y + 2*fontsize)  
  text("Wind velocity = "+ data.wind.speed,     
      posX = x,  
      posY = y + 3*fontsize) 
